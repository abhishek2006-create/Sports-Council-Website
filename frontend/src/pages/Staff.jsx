...
export default function Staff() {
    ...
    const faculty = [
        {
            ...
            previousHolders: [
                {
                    name: "Previous Holder Name",
                    year: "2024 - 2025",
                    description:
                        "Short description about the previous holder.",
                    img: "/images/previous_holder.jpg"
                },
                {
                    name: "Another Previous Holder",
                    year: "2023 - 2024",
                    description:
                        "Short description about the previous holder.",
                    img: "/images/previous_holder2.jpg"
                }
            ]
        },

        {
            ...
            previousHolders: [
                {
                    name: "Previous Sports Officer",
                    year: "2023 - 2024",
                    description:
                        "Details about the previous Deputy Sports Officer.",
                    img: "/images/previous_officer.jpg"
                }
            ]
        },
    ...
    return (
        <div
            className="bg-slate-950 min-h-screen w-full pt-5 pb-20 px-4
