                ...
                {club.image && (
                    <div className="flex justify-center mb-8">
                        <motion.div
                            ...
                            className="relative"
                        >
                            <div className="w-40 h-40 md:w-52 md:h-52 bg-white rounded-full p-6 md:p-8 shadow-xl flex items-center justify-center border-4 border-teal-500">
                                <img
                                    src={club.image}
                                    alt={club.name}
                                    className="w-full h-full object-contain filter drop-shadow-lg brightness-110 contrast-150 saturate-150"
                                    onError={(event) => {
