...
export default function Contact() {
  return (
    <div className="relative min-h-screen bg-slate-950 font-poppins text-white overflow-hidden py-24 px-6 flex items-center justify-center">
      ...
      <div className="relative z-10 max-w-5xl w-full mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-black text-slate-100 leading-none tracking-tight">
            Contact{" "}
          ...
          <motion.div
            ...
            className="h-1 bg-gradient-to-r from-teal-400 to-emerald-400 mx-auto mt-4 rounded-full"
          />
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div
            ...
            className="bg-slate-900 backdrop-blur-md
